...
const translations = {
    en: {
        ...
        about_3: "WHO WE ARE?",
        about_4: `WE'RE FROM DIFFRENT CULTURES (AN INDONISIAN WOMAN & AN EGYPTIAN MAN) , WE ARE IN A DISTANCE RELATIONSHIP MY LOVE TO MY WOMAN IS ALWAYS THE MOTIVATION TO MAKE ALL OF THAT, ALSO
        WE SHARE THE SAME LOVE OF FOOD , SO WE DECIDED TO SHARE THAT WITH YOU,
        I BET YOU GUYS WILL LOVE MY WOMAN FOOD`,
    ...
    in: {
        ...
        brand_quote: "~FOOD4UNIQUE",
        about_3: "SIAPA KITA?",
        about_4: `KAMI DARI BUDAYA YANG BERBEDA (WANITA INDONISIAN & PRIA MESIR), KAMI DALAM HUBUNGAN JARAK CINTAKU KEPADA WANITAKU SELALU MOTIVASI UNTUK MELAKUKAN SEMUA ITU JUGA
        KAMI BERBAGI CINTA MAKANAN YANG SAMA, JADI KAMI MEMUTUSKAN UNTUK BERBAGI DENGAN ANDA,
        AKU TETAP KALIAN AKAN MENYUKAI MAKANAN WANITA SAYA`,
